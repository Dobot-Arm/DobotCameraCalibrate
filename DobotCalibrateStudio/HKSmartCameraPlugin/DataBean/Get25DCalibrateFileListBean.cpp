#include "Get25DCalibrateFileListBean.h"

bool CGet25DCalibrateFileListRequestBean::fromJson(const QJsonObject &obj)
{
...
QJsonObject CGet25DCalibrateFileListRequestBean::toJsonObject() const
{
    QJsonObject obj;
...
bool CGet25DCalibrateFileListRequestParams::fromJson(const QJsonObject &obj)
{
...
QJsonObject CGet25DCalibrateFileListRequestParams::toJsonObject() const
{
    QJsonObject obj;
...
/*********************************************************************************************************/
/*********************************************************************************************************/
bool CGet25DCalibrateFileListResponseBean::fromJson(const QJsonObject &obj)
{
...
QJsonObject CGet25DCalibrateFileListResponseBean::toJsonObject() const
{
    QJsonObject obj;
...
bool CGet25DCalibrateFileListResponseResult::fromJson(const QJsonObject &obj)
{
    if (obj.contains("data") && obj["data"].isObject())
    {
        m_data.fromJson(obj["data"].toObject());
...
QJsonObject CGet25DCalibrateFileListResponseResult::toJsonObject() const
{
    QJsonObject obj;
    obj.insert("data", m_data.toJsonObject());
    return obj;
