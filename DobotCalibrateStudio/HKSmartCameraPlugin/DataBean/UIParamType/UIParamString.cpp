...
bool UIParamString::fromJson(const QJsonObject &obj)
{
    ...
    if (obj.contains("value") && obj["value"].isString()) value = obj["value"].toString();
    return true;
}

QJsonObject UIParamString::toJsonObject() const
{
    QJsonObject obj;
