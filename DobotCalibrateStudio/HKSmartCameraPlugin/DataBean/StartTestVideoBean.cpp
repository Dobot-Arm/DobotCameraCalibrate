#include "StartTestVideoBean.h"

bool CStartTestVideoRequestBean::fromJson(const QJsonObject &obj)
{
...
QJsonObject CStartTestVideoRequestBean::toJsonObject() const
{
    QJsonObject obj;
...
bool CStartTestVideoRequestParams::fromJson(const QJsonObject &obj)
{
...
QJsonObject CStartTestVideoRequestParams::toJsonObject() const
{
    QJsonObject obj;
...
/*********************************************************************************************************/
/*********************************************************************************************************/
bool CStartTestVideoResponseBean::fromJson(const QJsonObject &obj)
{
...
QJsonObject CStartTestVideoResponseBean::toJsonObject() const
{
    QJsonObject obj;
...
bool CStartTestVideoResponseResult::fromJson(const QJsonObject &obj)
{
    if (obj.contains("data") && obj["data"].isObject())
    {
        m_data.fromJson(obj["data"].toObject());
...
QJsonObject CStartTestVideoResponseResult::toJsonObject() const
{
    QJsonObject obj;
    obj.insert("data", m_data.toJsonObject());
    return obj;
